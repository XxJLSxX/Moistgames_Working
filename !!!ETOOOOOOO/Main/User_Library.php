...
<head>
    ...
    <link rel="stylesheet" href="../css/user_library_css.css?+1">
...
<body>
    ...
    <section id="section">
        <div class="game-library-container">
            ...
            <div class="usergame-records">
                <?php while ($row = $itemsResult->fetch_assoc()) : ?>
                    <div class="usergame-entry">
                        <div class="usergame-image-container">
                            <img src="../Games/<?php echo $row['Game_Name']; ?>/Image.png">
                        </div>
                        <div class="usergame-details-container">
                            <div class="usergame-title-section">
                                <p class="usergame-title"><?php echo $row['Game_Name']; ?></p>
                                ...
                                <div class="rating" data-rating="<?php echo $rating; ?>">
                                    ...
                                    ?>
                                    <p class="usergame-price-desc"><a href="" style="all: unset; font-size: 14px;">View Details</a></p>
                                </div>                                
                            </div>
                            <div class="usergame-info-section">
                                <p class="usergame-developer"><?php echo $row['Developer_Name']; ?></br></p>
                                <p class="usergame-genre"><?php echo $row['Category']; ?></p>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
