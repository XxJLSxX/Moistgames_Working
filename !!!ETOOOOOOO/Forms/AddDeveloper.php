...
<body style="background-color: #1e1e1e">
    <div class="container">
        ...
        <p style="font-size: 25px; margin-top: 16px; margin-bottom: 29px">Add Developer<br>
        <img src="../img/default-icon.png" style="margin-top: 14px; width: 150px; height: 150px;"></p>

        <label for="name">Developer Name</label><br>
        <input type="text" name="Developer_Name" placeholder="Name" required><br><br>

        <label for="email">Email</label><br>
        <input type="email" name="Developer_Email" placeholder="Email" required><br><br>

        <label for="address">Address</label><br>
        <input type="text" name="Developer_Address" placeholder="Address" required><br><br>

        <label for="about_desc">About Description:</label><br>
        <textarea name="Developer_Desc" rows="4" placeholder="Description" required></textarea><br><br>
