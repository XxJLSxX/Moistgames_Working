...
<div class="modal fade" id="AddGame-Form" tabindex="-1" aria-labelledby="AddPopup" aria-hidden="true">
  ...
  <!------------------------------------------------------------ Update Game Popup ------------------------------------------------------------>
  <div class="modal fade" id="EditGame-Form" tabindex="-1" aria-labelledby="UpdatePopup" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content" style="background-color: #6d6c6c; border-radius: 10px;">
        <div class="modal-body" style="background-color: #6d6c6c;">
          <center>
                    ...
                    <div class="game-entry">
                        ...
                        <div class="game-details-container">
                            <div class="game-title-section">
                                ...
                                <button class='edit-button' value="<?php $row['Game_ID']?>" style='margin-top: 5px;' data-bs-toggle="modal" data-bs-target="#EditGame-Form">Edit</button>
                            </div>
...
<script 
    src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js?+1"
