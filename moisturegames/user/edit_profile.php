...
<body style="background-color: #1e1e1e">
    <div class="container">
        ...
        <p style="font-size: 25px; margin-top: 16px; margin-bottom: 29px">Edit Profile <br><img src="../images/default-icon.png" style="margin-top: 14px; width: 150px; height: 150px;"></p>
